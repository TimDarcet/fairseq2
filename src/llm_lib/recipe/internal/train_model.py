...
from llm_lib2.checkpoint import CheckpointManager, ModelMetadataDumper
...
from llm_lib2.recipe.config import ModelSection, TrainerSection
...
from llm_lib2.recipe.internal.data_parallel import _DataParallelModelWrapper
...
class _StandardTrainModelBootstrapper(_TrainModelBootstrapper):
    ...
    def _load_model(self) -> _ModelHolder:
        ...
        if has_checkpoint:
            ...
            model = family.create_new_model(
                config, gangs, dtype, meta=family.supports_meta, init_rank0_only=True
            )
    ...
    def _create_new_model(self) -> _ModelHolder:
        ...
        if has_checkpoint:
            ...
            model = family.create_new_model(
                config, gangs, dtype, meta=False, init_rank0_only=True
            )
