...
from llm_lib2.models.wav2vec2.config import Wav2Vec2Config


def convert_wav2vec2_state_dict(
    state_dict: dict[str, object], config: Wav2Vec2Config
) -> dict[str, object]:
    try:
    ...
    if "mask_emb.weight" in state_dict:  # llm_lib
